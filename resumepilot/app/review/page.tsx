...
if (countError) {  
  alert("Could not check review count.");  
  setSaving(false);  
  return;  
}  
...
const jobSkills = commonSkills.filter(function (skill) {  
  return jobText.includes(skill);  
});  

const matched = jobSkills.filter(function (skill) {  
  return resumeText.includes(skill);  
});  

const missing = jobSkills.filter(function (skill) {  
  return !resumeText.includes(skill);  
});  
        ...
        <div className="grid md:grid-cols-2 gap-6">  
          ...
          <div className="p-6 rounded-xl bg-green-950 border border-green-800">  
            ...
            <div className="flex flex-wrap gap-2">  
              ...
              {matchingSkills.map(function (skill) {  
                return (  
                  <span  
                    key={skill}  
